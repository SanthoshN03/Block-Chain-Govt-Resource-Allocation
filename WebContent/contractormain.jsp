...
<!--   <li><b><a href="rejectview.jsp">REJECTED</a></b></li> -->
  <li><b><a href="appointview.jsp">APPOITED</a></b></li>
    ...
    <nav class="navbar navbar-default navbar-fixed-top" data-spy="affix" data-offset-top="205">
        <div class="container-fluid">
            <div class="navbar-header">
                <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#myNavbar"> <span class="icon-bar"></span> <span class="icon-bar"></span> <span class="icon-bar"></span> </button> <a class="navbar-brand" href="#"><%=department %></a> </div>
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="index.jsp">Home</a></li>
                    <li><a href="viewcontract.jsp">View Contract</a></li>
                    <li><a href="appointview.jsp">Appointed List</a></li>
                    <li><a href="contarctlogin.jsp">Logout</a></li>
                </ul>
            </div>
        </div>
    </nav>
    <header style="background-image:url('image/gm1.jpg');">
        <div class="header-content">
            <div class="header-content-inner">
                <h1>Contractors</h1>
                <p>Tender is the response to an invitation of offer. This invitation provides services/products at quoted price at specific quality (with specific conditions). Generally tenders are floated by government undertakings, corporate players, and financial institutions.<br></br>

They want goods at large scales in order to meet the production requirements. In most cases, in order to meet the requirement they can't deliver on their own and they have to go to a third party supplier to meet the requirements. For these reasons they invite bids from third party suppliers.</p>  </div>
        </div>
    </header>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2 col-sm-12 col-xs-12">
                    <h3>About</h3>
                    <p>Government companies or corporations will go for tenders or quotations to meet their large requirements. They manage their resources in the best way and provide value for their money.</p>
                      <p>Tender is the process of asking suppliers to bid on products/services required by a company whereas quotation is the response to bidders, where they quote their price for goods/services. Quotation is also termed as an estimation given by professionals for jobs. Tender is more formal than quotations.
