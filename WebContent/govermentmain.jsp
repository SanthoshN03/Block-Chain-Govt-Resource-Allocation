...
<head>
    ...
    <title>Government Mainpage</title>
...
<!-- <ul>
  <li><a class="active" href="#home">HOME</a></li>
    <li><a href="Complaintview.jsp">PUBLIC COMPLIANT</a></li>
     <li><a href="Status.jsp">COMPLIANT STATUS</a></li>
   <li><a href="Activate.jsp">ACTIVATE</a></li>
<li><a href="detailview.jsp">DEPART STATUS</a></li>
...
<body>    
    ...
    <header id="topHeader">
        ...
        <nav>
            <span class="logo">Government</span>
            <div class="menu-btn-3" onclick="menuBtnFunction(this)">
                <span></span>
            </div>
            <div class="mainMenu">
                <a href="Complaintview.jsp"><span>Public complaint</span></a>
                <a href="Status.jsp"><span>Complaint Status</span></a>
                <a href="Activate.jsp"><span>Activate</span></a>
                <a href="detailview.jsp"><span>Department Status</span></a>
                <a href="responseview.jsp"><span>Response</span></a>
                <a href="tendorlist.jsp">Tender Details</a>
    ...
    <section id="intro">
        <div id="intro-info">
            <div>
                ...
                <div id="intro-tag-btn">
                    <span>A government is the system or group of people governing an organized community, generally a state...</span>
        ...
        <div id="development-img">
            <img src="image/istockphoto-1008159054-612x612.jpg" width="500px;"alt="Mobile App Development" title="Mobile App Development"/>
        </div>
    </section>

    <section id="delivery">
        <h1 class="sec-heading">Government</h1>
        <div class="col-5 delivery-img">
            <img src="image/istockphoto-182378442-612x612.jpg" alt="Productivity Delivering Experience" title="Delivering Experience Since 2009"/>
        </div>
        <div class="col-7">
            <h2>Definitions and etymology</h2>
            <p>
                In the case of its broad associative definition, government normally consists of legislature, executive, and judiciary. Government is a means by which organizational policies are enforced, as well as a mechanism for determining policy. In many countries, the government has a kind of constitution, a statement of its governing principles and philosophy.

While all types of organizations have governance, the term government is often used more specifically to refer to the approximately 200 independent national governments and subsidiary organizations</p>
