...
<table class="table table-xm table-dark">
  <thead>
    <tr>
     ...
     <tr>
     <td style="text-align: left;"><%=rs.getString(1)%></td>
      <td style="text-align: left;"><%= rs.getString(3) %></td>

      <td style="text-align: left;"><a href="respose.jsp?tenderid=<%=rs.getString(1)%>"><button class="btn btn-primary">VIEW</button></a></td>
